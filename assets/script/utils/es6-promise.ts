...
let _ES6Promise:any = (function (global:any, factory) {
	// typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
	typeof define === 'function' && (<any>define).amd ? define(factory) :
...
let browserGlobal:any = browserWindow || {};
...
function useMutationObserver() {
  ...
  let node:any = document.createTextNode('');
...
let PROMISE_ID = Math.random().toString(36).substring(2);
...
function tryThen(then$$1, value, fulfillmentHandler, rejectionHandler, ext) {
  try {
