...
let QRCodeUtil: any = function (typeNumber, errorCorrectLevel) {
...
QRCodeUtil.prototype = {
    ...
    makeImpl: function (test, maskPattern) {
        ...
        if (this.dataCache == null) {
            this.dataCache = QRCodeUtil.createData(this.typeNumber, this.errorCorrectLevel, this.dataList);
        }
...
QRCodeUtil.PAD0 = 0xEC;
QRCodeUtil.PAD1 = 0x11;

QRCodeUtil.createData = function (typeNumber, errorCorrectLevel, dataList) {
    ...
    while (true) {
        ...
        buffer.put(QRCodeUtil.PAD0, 8);

        if (buffer.getLengthInBits() >= totalDataCount * 8) {
            break;
        }
        buffer.put(QRCodeUtil.PAD1, 8);
    }

    return QRCodeUtil.createBytes(buffer, rsBlocks);
}

QRCodeUtil.createBytes = function (buffer, rsBlocks) {
