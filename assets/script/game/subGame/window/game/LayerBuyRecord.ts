...
import { BuyRecordItem } from './gameItem/BuyRecordItem';
const { ccclass, property } = _decorator;

@ccclass('LayerBuyRecord')
export class LayerBuyRecord extends GameBaseWindow {
    ...
    private _loadRecord() {
        SubGameCtrl.getInstance().contRecord(this._page++);
    }
    ...
    onDispathcGameEvent(eventId: GameEvent, eventData: any): void {
        switch (eventId) {
            case GameEvent.EVENT_GAME_SELF_RECORD:
                {
